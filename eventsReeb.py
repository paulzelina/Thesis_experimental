            ...
            if not flag_t1[ti] and not flag_t2[tj] and checkEpsilonDistance(t1[ti], t2[tj], eps):
                ...
                while (flag_insert and last_j < len(t2) and first_j >= 0):
                    ...
                    if (first_i - 1 >= 0) and not flag_t1[first_i - 1]:
                        if first_j - 1 >= 0 and not flag_t2[first_j - 1] and checkEpsilonDistance(t1[first_i - 1],
                                                                                                  t2[first_j - 1], eps):
                            first_i = first_i - 1
                            first_j = first_j - 1
                            ...
                            flag_insert = True
                        elif last_j + 1 < len(t2) and not flag_t2[last_j + 1] and checkEpsilonDistance(t1[first_i - 1],
                                                                                                       t2[last_j + 1],
                                                                                                       eps):
                            first_i = first_i - 1
                            last_j = last_j + 1
                            ...
                            flag_t2[last_j] = True
                            flag_insert = True
                        elif first_j + 1 < len(t2) and not flag_t2[first_j + 1] and checkEpsilonDistance(
                            ...
                            flag_t2[first_j] = True
                            flag_insert = True
                        elif last_j - 1 >= 0 and not flag_t2[last_j - 1] and checkEpsilonDistance(t1[first_i - 1],
                                                                                                  t2[last_j - 1], eps):
                            first_i = first_i - 1
                            last_j = last_j - 1
                            flag_t1[first_i] = True
                    ...
                    if (last_i + 1 < len(t1)) and not flag_t1[last_i + 1]:
                        if first_j - 1 > 0 and not flag_t2[first_j - 1] and checkEpsilonDistance(t1[last_i + 1],
                                                                                                 t2[first_j - 1], eps):
                            last_i = last_i + 1
                            first_j = first_j - 1
                            flag_t1[last_i] = True
                            flag_t2[first_j] = True
                            flag_insert = True
                        elif last_j + 1 < len(t2) and not flag_t2[last_j + 1] and checkEpsilonDistance(t1[last_i + 1],
                                                                                                       t2[last_j + 1],
                                                                                                       eps):
                            last_i = last_i + 1
                            last_j = last_j + 1
                            ...
                            flag_t2[last_j] = True
                            flag_insert = True
                        elif first_j + 1 < len(t2) and not flag_t2[first_j + 1] and checkEpsilonDistance(t1[last_i + 1],
                                                                                                         t2[
                                                                                                             first_j + 1],
                                                                                                         eps):
                            last_i = last_i + 1
                            ...
                            flag_t2[first_j] = True
                            flag_insert = True
                        elif last_j - 1 > 0 and not flag_t2[last_j - 1] and checkEpsilonDistance(t1[last_i + 1],
                                                                                                 t2[last_j - 1], eps):
                            last_i = last_i + 1
                            last_j = last_j - 1
                            flag_t1[last_i] = True
                    ...
                    if (first_j - 1 >= 0) and not flag_t2[first_j - 1]:
                        if first_i - 1 >= 0 and not flag_t1[first_i - 1] and checkEpsilonDistance(t2[first_j - 1],
                                                                                                  t1[first_i - 1], eps):
                            first_j = first_j - 1
                            first_i = first_i - 1
                            flag_t1[first_i] = True
                            flag_t2[first_j] = True
                            flag_insert = True
                        elif last_i + 1 < len(t1) and not flag_t1[last_i + 1] and checkEpsilonDistance(t2[first_j - 1],
                                                                                                       t1[last_i + 1],
                                                                                                       eps):
                            first_j = first_j - 1
                            last_i = last_i + 1
                            ...
                            flag_t2[first_j] = True
                            flag_insert = True
                        elif first_i + 1 < len(t1) and not flag_t1[first_i + 1] and checkEpsilonDistance(
                            ...
                            flag_t1[first_i] = True
                            flag_insert = True
                        elif last_i - 1 >= 0 and not flag_t1[last_i - 1] and checkEpsilonDistance(t2[first_j - 1],
                                                                                                  t1[last_i - 1], eps):
                            first_j = first_j - 1
                            last_i = last_i - 1
                            flag_t1[last_i] = True
                    ...
                    if (last_j + 1 < len(t2)) and not flag_t2[last_j + 1]:
                        if first_i - 1 >= 0 and not flag_t1[first_i - 1] and checkEpsilonDistance(t2[last_j + 1],
                                                                                                  t1[first_i - 1], eps):
                            last_j = last_j + 1
                            first_i = first_i - 1
                            flag_t1[first_i] = True
                            flag_t2[last_j] = True
                            flag_insert = True
                        elif last_i + 1 < len(t1) and not flag_t1[last_i + 1] and checkEpsilonDistance(t2[last_j + 1],
                                                                                                       t1[last_i + 1],
                                                                                                       eps):
                            last_j = last_j + 1
                            last_i = last_i + 1
                            ...
                            flag_t2[last_j] = True
                            flag_insert = True
                        elif first_i + 1 < len(t1) and not flag_t1[first_i + 1] and checkEpsilonDistance(t2[last_j + 1],
                                                                                                         t1[
                                                                                                             first_i + 1],
                                                                                                         eps):
                            last_j = last_j + 1
                            ...
                            flag_t2[last_j] = True
                            flag_insert = True
                        elif last_i - 1 >= 0 and not flag_t1[last_i - 1] and checkEpsilonDistance(t2[last_j + 1],
                                                                                                  t1[last_i - 1], eps):
                            last_j = last_j + 1
                            last_i = last_i - 1
                            flag_t1[last_i] = True
